        ...
        <section id="skills" className="scroll-mt-28">
          <SectionReveal>
            ...
            <div className="mt-6 flex flex-wrap items-center justify-center gap-2 sm:mt-8 sm:justify-start sm:gap-3">
              {(["web", "software", "data"] as SkillFilter[]).map((filter) => (
                <button
                  key={filter}
                  className={`rounded-full border px-4 py-1.5 text-[10px] font-semibold uppercase tracking-[0.2em] transition-all duration-300 sm:px-5 sm:py-2 sm:text-xs ${
                    activeSkill === filter
            ...
            {activeSkillGroup ? (
              <div className="mt-8">
                <div className="section-card star-border w-full p-6 sm:p-8">
                  ...
                  <div className="mt-4 grid grid-cols-2 gap-2.5 items-start sm:mt-6 sm:gap-3 sm:grid-cols-3 md:grid-cols-4">
              ...
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div className="flex flex-wrap items-center justify-center gap-2 sm:justify-start sm:gap-3">
                  {projectFilters.map((filter) => (
                    <button
                      key={filter.value}
                      className={`rounded-full border px-3 py-1.5 text-[10px] font-semibold uppercase tracking-[0.2em] transition-all duration-300 sm:px-4 sm:py-2 sm:text-xs ${
