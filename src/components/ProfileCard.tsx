...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  const shineStyle = {
    maskImage:
      "linear-gradient(to top, transparent 0%, rgba(0,0,0,0.35) 45%, rgba(0,0,0,0.9) 85%)",
    WebkitMaskImage:
      "linear-gradient(to top, transparent 0%, rgba(0,0,0,0.35) 45%, rgba(0,0,0,0.9) 85%)",
  ...
  return (
    ...
    >
      {(showBehindGlow ?? behindGlowEnabled) && (
        <div
      ...
      <div ref={shellRef} className="relative z-[1] group">
        ...
        >
          ...
          >
            {showIcon && iconUrl ? <div style={iconPatternStyle} /> : null}
